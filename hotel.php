                ...
                <img src="./images/bedroom1.jpg">
                  <h3>Vip suite</h3>
                    ...
                    rest sleep here  <br>at de luna we <br>
                      provide the best .</h4>
                      <button class="register-btn" href="index.html">BOOk NOW</button>
                 ...
                 <div class="rooms-cards">
                  <div class="room-card">
                    ...
                    <button id="bookingButton" name="booknow"  class="register-btn" href="index.html"> BOOK N0W</button>
...
<script>
document.getElementById("bookingButton").addEventListener("click", myFunction);

function myFunction() {
  document.getElementById("bookingButton").innerHTML = "Booked!";
